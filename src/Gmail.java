...
public class Gmail {
	...
	static String login = "rajandpipaliya@gmail.com";
	static String password = "***";//add your password
	static String to = "rajandp36@gmail.com";
	static String cc = "dddd";
	static String bcc = "xscdvfdgb";
	static String subject = "first message";
	static String body = "dvfdgsdsf";
